...
// Expects a bare number (1-10) back — no JSON, no prose.
...
On a scale of 1-10, how severe is their desperation today? Respond with ONLY the bare number \
(e.g. "7") — no words, no punctuation, no explanation.`;
